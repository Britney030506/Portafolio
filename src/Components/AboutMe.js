...
const AboutMe = () => {
  return (
    <div id="aboutme" className="mt-[100px]">
      <div className="w-full bg-purple-600 h-[300px]  justify-center items-center md:rounded-t-[150px] rounded-t-[75px]">
        <h1 className="text-white text-[50px] pt-[20px] font-bold text-center">
          About <span className="text-black">Me</span>
        </h1>
        <h1 className="w-full px-10 md:px-48 lg:px-80 mt-[25px] text-white text-[18px]">
